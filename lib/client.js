...
//
// v0.4.0 —— DSH 原生风格搜索栏（查词/词源/问答），注册进 ui-conversation
// 的 conversation.top 插槽：固定在聊天框最上面、随列头常驻（无会话时也
// 显示）、滚动时不动。样式改用 DSW 设计令牌（--dsw-alias-*），与输入框
// 卡片同款表面/描边/圆角/阴影，查询按钮为紧凑原生小胶囊。
