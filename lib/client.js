...
//
// v0.4.1 —— DSH 原生风格搜索栏（查词/词源/问答），注册进 ui-conversation
// 的 conversation.input.dock 插槽：显示在输入框卡片上方。样式使用 DSW
// 设计令牌（--dsw-alias-*），与输入框卡片同款表面/描边/圆角/阴影，查询
// 按钮为紧凑原生小胶囊。
...
function apply(ctx) {
  ...
  // 输入框卡片上方的全宽独立行；rc.6 与后续 DSH 版本均提供该插槽。
