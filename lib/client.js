...
var CSS =
  ...
  '.es-topbar{position:fixed;top:0;left:0;right:0;z-index:9000;background:var(--es-bg);border-bottom:1px solid var(--es-line);padding:8px 12px}' +
  '.es-form{display:flex;align-items:center;gap:10px;max-width:720px;margin:0 auto}' +
  '.es-mode{display:flex;align-items:center;gap:4px;flex:none;padding:4px;border:1px solid var(--es-line);border-radius:999px;background:var(--es-panel)}' +
  '.es-mode-btn{border:none;background:transparent;color:var(--es-muted);font-size:14px;font-weight:600;padding:6px 12px;border-radius:999px;cursor:pointer;box-shadow:none}' +
  '.es-mode-btn:hover{color:var(--es-text)}' +
  '.es-mode-btn.es-active{background:var(--es-accent);color:var(--es-bg)}' +
  '.es-capsule{flex:1;min-width:0;display:flex;align-items:center;gap:4px;padding:4px 6px 4px 12px;background:var(--es-panel);border:1px solid var(--es-line);border-radius:999px}' +
  ...
  '.es-go{border-radius:999px;padding:13px 24px;font-size:16px;flex:none;border:1px solid var(--es-accent);background:linear-gradient(135deg,var(--es-accent) 0%,var(--es-accent-2) 100%),linear-gradient(115deg,transparent 30%,rgba(255,255,255,.26) 50%,transparent 70%);background-size:100% 100%,220% 100%;background-position:0 0,130% 0;color:#fff;cursor:pointer}' +
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'es-mode', role: 'group', 'aria-label': '查询模式' },
          ['lookup', 'etymology', 'qa'].map(function (id) {
            return React.createElement(
              'button',
              {
                key: id,
                type: 'button',
                className: 'es-mode-btn' + (mode === id ? ' es-active' : ''),
