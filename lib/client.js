...
var CSS =
  ...
  '.es-capsule{display:flex;align-items:center;gap:4px;padding:3px 6px 3px 10px;background:var(--es-panel);border:1px solid var(--es-line);border-radius:999px;box-shadow:0 1px 2px rgba(22,40,72,.06),0 4px 14px rgba(22,40,72,.08)}' +
  '.es-capsule:focus-within{border-color:var(--es-accent);box-shadow:0 0 0 3px rgba(0,0,0,.08)}' +
  '.es-capsule input{width:clamp(90px,14vw,200px);padding:6px 0;font-size:14px;border:none;background:transparent;box-shadow:none;outline:none;color:var(--es-text)}' +
  ...
  '.es-go{border-radius:999px;padding:7px 16px;font-size:14px;flex:none;border:1px solid var(--es-accent);background:linear-gradient(135deg,var(--es-accent) 0%,var(--es-accent-2) 100%),linear-gradient(115deg,transparent 30%,rgba(255,255,255,.26) 50%,transparent 70%);background-size:100% 100%,220% 100%;background-position:0 0,130% 0;color:#fff;cursor:pointer}' +
